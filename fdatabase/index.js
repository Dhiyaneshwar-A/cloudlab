...
const firebaseConfig = {
  apiKey: "AIzaSyBEgl0AKP9RBgqoqp6ZLAhCbEj6iH7LlV8",
  authDomain: "attendancemonitoringsyst-9728c.firebaseapp.com",
  projectId: "attendancemonitoringsyst-9728c",
  storageBucket: "attendancemonitoringsyst-9728c.appspot.com",
  messagingSenderId: "325815303435",
  appId: "1:325815303435:web:d80ca74edbee144d82360e",
  measurementId: "G-EZFW1MXRL2"
};
...
const storageRef = ref(storage);
    ...
    document.getElementById('submit2').addEventListener("click", async () => {
        ...
        const storageRef = ref(storage, 'gs://cloudterminallab-8dba0.appspot.com/cloud/'+file.name);
...
uploadTask.on('state_changed', 
  ...
  () => {
    ...
    document.getElementById('submit7').addEventListener("click", async () => {
        const file= document.getElementById('file').files[0];
        getDownloadURL(ref(storage, 'gs://cloudterminallab-8dba0.appspot.com/cloud/'+file.name))
        .then((url) => {
    ...
    document.getElementById('submit8').addEventListener("click", async () => {
        const file= document.getElementById('file').files[0];
        const desertRef = ref(storage,  'gs://cloudterminallab-8dba0.appspot.com/cloud/'+file.name);
